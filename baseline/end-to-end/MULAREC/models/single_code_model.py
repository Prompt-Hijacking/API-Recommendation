...
class Seq2Seq(nn.Module):
    ...
    def forward(self, src_code_ids=None, src_code_mask=None, \
        ...
        if target_ids is not None:
            ...
            out = self.decoder(
                tgt_embeddings, src_code_encoder_output, tgt_mask=attn_mask, \
                memory_key_padding_mask=(1 - src_code_mask).bool())
            ...
            for i in range(src_code_ids.shape[0]):
                context = src_code_encoder_output[:, i:i + 1]
