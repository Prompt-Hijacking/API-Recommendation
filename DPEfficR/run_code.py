...
def read_and_filter_data(data_path):
    ...
    return data.filter(items=["source_code", "target_api"])
...
# 添加 --output_dir 参数
parser.add_argument("--output_dir", type=str, default="./code", help="Output directory for saving logs and models.")
args = parser.parse_args()

# 使用 args.output_dir 构建 log_file 路径
log_file = os.path.join(args.output_dir, f"code_training_log.txt")
