...
if __name__ == "__main__":
    ...
    argparser.add_argument('--reference', type=str, default='target_api.csv', help='Reference File')
    argparser.add_argument('--candidate', type=str, default='annotation_yuxian1.txt', help='Candidate file')
