...
peft_model_id = "../bimodal_1500/model_best_bleu"
...
# test_data = pd.read_csv("/data/CM/Project/LLM4ApiRec/MulaRec/data/test_3_lines_new_bimodal.csv")[:8]
test_data = pd.read_csv("/data/CM/Project/LLM4ApiRec/MulaRec/data/test_3_lines_new_bimodal.csv")
columns_to_keep = ["bimodal", "target_api"]
test_data = test_data.filter(items=columns_to_keep)
test_dataset = test_data[["bimodal", "target_api"]]
...
output_json_path = "bimodal_IA3_20.json"
...
# # 将预测和参考保存到文件
# df = pd.DataFrame(csv_true_list)
# df.to_csv("test_bimodal_hyp.csv", index=False, header=None)
# df = pd.DataFrame(csv_pred_list)
# df.to_csv("test_bimodal_ref.csv", index=False, header=None)
...
# # 将预测和参考保存到文件
# df = pd.DataFrame(csv_true_list)
# df.to_csv("./1500/test_bimodal_ref.csv", index=False, header=None)
# df = pd.DataFrame(csv_pred_list)
# df.to_csv("./1500/test_bimodal_hyp.csv", index=False, header=None)